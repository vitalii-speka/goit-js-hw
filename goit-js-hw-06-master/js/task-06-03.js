...
// вариант 1 - работает
// const getUsersWithGender = (users, gender1) => {
//   const maleGender = users.filter(({ gender }) => gender === gender1);
//   return maleGender.map(({ name }) => name);
// };

//вариант 2 - не работает код ниже.... Были лишние скобки {} !!!
// const getUsersWithGender = (users, gender1) => {
//   users.filter(({ gender }) => gender === gender1).map(({ name }) => name);
// };
